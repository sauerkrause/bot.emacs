...
(define-reply advice
  '("Eat crayons. Poop rainbows."
    ...
    "Smoke pot. Fly with dragons."
    "Drink lotion. Cure sore throat."
    "Play shit backwards. Obey Satan."
    "Eat Dubstep MP3s. Recapture youth."
    "Drink motor oil. Keep your engines running."
    "Buy condoms. Wink at clerk."
    "Jump into lava. Cleanse your pores."
    "Suck helium. Defy gravity."
    "Drink bleach. Gain white privilege."
    "Noun verb. Noun verb."
    "Swallow magnets. Become attractive."
    "Right click blinking car. Drive away.")
  "Gives you advice")
...
(define-reply gandhi
  ...
  "Quotes Gandhi, the greatest pacifist")

(define-reply stig 
'("[06x01] “Some say he never blinks, and that he roams around the woods at night foraging for wolves. All we know is he’s called the Stig.”"
